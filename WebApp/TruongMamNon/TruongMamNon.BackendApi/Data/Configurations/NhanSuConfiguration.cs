...
namespace TruongMamNon.BackendApi.Data.Configurations
{
    public class NhanSuConfiguration : IEntityTypeConfiguration<NhanSu>
    {
        public void Configure(EntityTypeBuilder<NhanSu> builder)
        {
            ...
            builder.Property(x => x.NoiSinh).IsRequired().HasMaxLength(200);
            builder.Property(x => x.CMND).IsRequired().HasMaxLength(200);
            builder.Property(x => x.NgayCap).IsRequired(false);
            builder.Property(x => x.DanToc).IsRequired(false).HasMaxLength(200);
            builder.Property(x => x.TonGiao).IsRequired(false).HasMaxLength(200);
            builder.Property(x => x.QuocTich).IsRequired(false).HasMaxLength(200);
            ...
            builder.Property(x => x.MaChucVu).IsRequired();
